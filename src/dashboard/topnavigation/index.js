        ...
        <div className="flex items-center pl-1 relative w-full sm:ml-0 sm:pr-2 lg:max-w-68">
          ...
          <div className="flex items-center justify-end ml-5 p-1 relative w-full sm:mr-0 sm:right-auto">
            ...
            <div className="block pr-5">
              <label for="Toggle3" className="inline-flex items-center p-2 rounded-md cursor-pointer dark:text-coolGray-800">
                <input id="Toggle3" type="checkbox" className="hidden peer" onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} />
                <span className="px-4 py-2 rounded-l-md bg-fuchsia-100 dark:bg-violet-400 peer-checked:dark:bg-coolGray-300">{theme == 'dark' ? 'Light Mode' : 'Dark mode'}</span>
              </label>
            </div>
