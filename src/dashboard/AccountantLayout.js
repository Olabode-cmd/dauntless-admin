...
import SideNavigation from './accountantroutes';
import DashboardProvider from './provider/context';

const style = {
    container: `bg-gray-900 dark:bg-white-400 h-screen overflow-hidden relative`,
...
export default function AccountantLayout({ children, page }) {
    return (
        <>
