...
export default function Navbar({ login }) {
    ...
    return (
        <div className="bg-yellow-400 dark:bg-slate-700 fixed z-50 right-px left-px drop-shadow-md">
            <div className="px-4 py-2 mx-auto lg:py-4 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="relative flex items-center justify-between lg:justify-center lg:space-x-16">
                    <ul className="flex items-center hidden space-x-8 lg:flex">
                        <li>
                            <Link
                                href="/">
                                <a className="text-sm tracking-wide text-white transition-colors duration-200 hover:text-teal-accent-400">Home</a>
                            </Link>
                        </li>
                        <li>
                            <Link
