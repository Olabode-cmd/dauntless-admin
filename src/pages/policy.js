    ...
    return (
        <div>
            ...
            <section className="bg-slate-200 py-6 dark:bg-slate-800 px-4 md:px-4">
                <div className="w-1/2 m-auto text-slate-300">
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">1.0 Your Privacy Rights</h2>
                    <p className="py-1">This Privacy Policy explains your privacy rights in relation to the collection,
                    ...
                    <p className="py-1">If you have created a username, identification code, password or any other
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">2.0 Consent</h2>
                    <p className="py-1">
                    ...
                    <p className="py-1">
                        ...
                        projects. </p>
                    <p>We may amend this Privacy Policy at any time by posting a revised version
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">3.0 Your Personal Information</h2>
                    <p className="py-1">
                        ...
                        device.</p>
                    <p className="py-1">The automatically collected information includes but not limited to- data
                        ...
                        moving images.</p>
                    <p className="py-1">We may also collect information you provide us including but not limited to
                    ...
                    <p className="py-1">We may also use information provided by third parties like social media
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">4.0 What we do with your personal information</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">5.0 Cookies</h2>
                    <p className="py-1">
                    ...
                    <p className="py-1">Our website uses only encrypted session cookies which are erased either
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">6.0 How we protect your personal information</h2>
                    <p className="py-1">
                    ...
                    <p className="py-1">We will kindly request your approval if we need to send your data to a
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">7.0 How We Share your information within Dauntless Exchangers and
                        other users.
                    </h2>
                    <p className="py-1">
                    ...
                    <p className="py-1">You accept that your pictures and testimonials on all social media
                        ...
                        materials.</p>
                    <p className="py-1"> From time to time, we may send you relevant information such as news
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">8.0 Security</h2>
                    <p className="py-1">
                    ...
                    <p className="py-1">SSL applies encryption between two points such as your device and the
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">9.0 Data Confidentiality Rights</h2>
                    <p className="py-1">
                        ...
                        you.</p>
                    <p className="py-1"> While Dauntless Exchangers is responsible for safeguarding the
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">10.0 Links to Other Websites and Premises</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">11.0 Governing Law</h2>
                    <p className="py">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">COOKIES POLICY</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">Essential Cookies</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">Performance Cookies</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">Functionality Cookies</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">DATA PROTECTION POLICY</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">Scope</h2>
                    <p className="py-1">
                        This policy refers to all parties who provide any amount of information to
                        us.
                    </p>

                    <h2 className="text-2xl my-2 text-slate-100 font-bold">What is covered under the Data Protection Policy</h2>
                    <p className="py-1">
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">Policy Elements</h2>
                    ...
                    <p className="py-1">Our data will not be:</p>
                    ...
                    <p className="py-1">In addition to ways of handling data, Dauntless Exchangers has direct
                    ...
                    <h2 className="text-2xl my-2 text-slate-100 font-bold">Actions</h2>
                    <p className="py-1"></p>
